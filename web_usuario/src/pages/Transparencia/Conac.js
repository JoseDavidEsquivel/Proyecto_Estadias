...
import './Conac.css'; // Estilos para la pagina landing Home
            ...
            <Row className="mt-5">
                <Col>
                    ...
                    <div className='tomo-container'>
                        <Row>
                            <h1 className='title-section'>CONAC: TOMO I MUNICIPAL</h1>
                        </Row>
                        <Row className='tomo-container'>
                            <div>
                                <p>
                                Con fundamento en los artículos 6, 7 y 9 de la Ley General de Contabilidad Gubernamental, el Consejo Nacional de
Armonización Contable reconoce que las Entidades Federativas, los Municipios y sus Entes Públicos deben
administrar sus recursos con base en los principios de legalidad, honestidad, eficacia, eficiencia, economía,
racionalidad, austeridad, transparencia, control y rendición de cuentas.</p>
                            </div>
                            <div className='ejercicio-container'>
                                <div className='ejercicio-title-container'>
                                    <p className='ejercicio-title'>Ejercicio 2024</p>
                                </div>
                                <div className='ejercicio-content'>
                                    <ul class="list-group list-group-flush">
                                        <a href='#'><li class="list-group-item">- 1er Trimestre</li></a>
                                        <a><li class="list-group-item">- 2do Trimestre</li></a>
                                        <a><li class="list-group-item">- 3er Trimestre</li></a>
                                        <a><li class="list-group-item">- 4to Trimestre</li></a>
                                        <a><li class="list-group-item">- Cuenta Pública Anual </li></a>
                                    </ul>
                                </div>
                            </div>
                        </Row>
