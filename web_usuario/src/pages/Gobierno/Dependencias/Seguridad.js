...
function Seguridad() {
    const navigatorLinks = [
        ...
        { name: 'Seguridad Publica', path: '#', current: true },
      ];
    ...
    useEffect(() => {
        const fetchFuncionario = async () => {
            try {
                ...
                const data = await response.json();
                const presidente = data.find(item => item.puesto === 'Seguridad Publica y Transito Municipal');
                ...
                <Col>
                    ...
                    <div className='generic-container generic-container-variant-1'>
                        ...
                        <div className='dependencia-responsabilidad-container'>
                            <p>Seguridad Pública y Tránsito Municipal son los responsables de implementar estrategias y
programas de prevención del delito para reducir la incidencia de actividades delictivas en la
comunidad, incluyendo patrullajes preventivos, vigilancia en áreas críticas, responder de manera
rápida y efectiva a emergencias, accidentes, desastres naturales y situaciones de crisis que
requieran intervención inmediata. Asi mismo regular y controlar el tránsito vehicular en el municipio
para garantizar la seguridad de conductores, peatones y ciclistas. </p>
                        </div>
                    </div>
                </Col>
            </Row>
