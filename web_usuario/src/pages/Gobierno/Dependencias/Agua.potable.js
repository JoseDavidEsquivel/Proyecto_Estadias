...
function Agua_potable() {
    const navigatorLinks = [
        ...
        { name: 'Agua Potable CAASST', path: '#', current: true },
      ];
    ...
    useEffect(() => {
        const fetchContacto = async () => {
            try {
                ...
                const presidenciaContacto = data.find(item => item.nombre_institucion === "Agua Potable CAASST");
            ...
            <Row className="mt-5">
                <Col>
                    ...
                    <div className='generic-container'>
                        <Row>
                            <h1 className='title-section'>AGUA POTABLE</h1>
                        </Row>
                    ...
                    <div className='generic-container generic-container-variant-1'>
                        <Row>
                            <h1 className='title-section'>RESPONSABILIDADES DE ESTA DEPENDENCIA</h1>
                        </Row>
                        <div className='dependencia-responsabilidad-container'>
                            <p>La CAASST es responsable de garantizar el suministro de agua potable a la población del área de su
jurisdicción. Esto implica la operación y mantenimiento de sistemas de abastecimiento de agua,
como pozos, plantas de tratamiento y redes de distribución, para asegurar que el agua sea segura y
de calidad, así mismo gestiona el sistema de alcantarillado para la recolección y disposición
adecuada de aguas residuales. Esto incluye la operación de redes de alcantarillado, estaciones de
bombeo, plantas de tratamiento de aguas residuales y la aplicación de normas ambientales para la
protección de los cuerpos de agua.</p>
                        </div>
                    </div>
                </Col>
            </Row>
