...
function Dif() {
    const navigatorLinks = [
        ...
        { name: 'Sistema DIF', path: '#', current: true },
      ];
    ...
    useEffect(() => {
        const fetchContacto = async () => {
            try {
                ...
                const presidenciaContacto = data.find(item => item.nombre_institucion === "Sistema DIF");
    ...
    useEffect(() => {
        const fetchFuncionario = async () => {
            try {
                ...
                const data = await response.json();
                const presidente = data.find(item => item.puesto === 'Presidente/a del Sistema DIF');
            ...
            <Row className="mt-5">
                <Col>
                    ...
                    <div className='generic-container'>
                        <Row>
                            <h1 className='title-section'>SISTEMA DIF</h1>
                        </Row>
                    ...
                    <div className='generic-container generic-container-variant-1'>
                        ...
                        <div className='dependencia-responsabilidad-container'>
                            <p>El Sistema para el Desarrollo Integral de la Familia (DIF) es la institución encargada de promover el
                            bienestar social y el desarrollo integral de las familias en la comunidad.</p>
                        </div>
                    </div>
                </Col>
            </Row>
