    ...
    useEffect(() => {
        const fetchContacto = async () => {
            try {
                ...
                const presidenciaContacto = data.find(item => item.nombre_institucion === "Presidencia Municipal");
    ...
    useEffect(() => {
        const fetchFuncionario = async () => {
            try {
                ...
                const data = await response.json();
                const presidente = data.find(item => item.puesto === 'Presidente/a Municipal');
                ...
                <Col>
                    ...
                    <div className='generic-container generic-container-variant-1'>
                        ...
                        <div className='dependencia-responsabilidad-container'>
                            <p>La Presidencia Municipal es responsable de la administración y gestión de los asuntos locales en el
municipio. Esto incluye la supervisión de los servicios públicos, la elaboración y ejecución de
políticas municipales, y la gestión de recursos y presupuestos municipales.</p>
                        </div>
                    </div>
                </Col>
            </Row>
