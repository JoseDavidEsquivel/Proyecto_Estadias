...
function Bibliotecas() {
    const navigatorLinks = [
        ...
        { name: 'Bibliotecas', path: '#', current: true },
      ];
    ...
    useEffect(() => {
        const fetchContacto = async () => {
            try {
                ...
                const presidenciaContacto = data.find(item => item.nombre_institucion === "Bibliotecas");
            ...
            <Row className="mt-5">
                <Col>
                    ...
                    <div className='generic-container'>
                        <Row>
                            <h1 className='title-section'>BIBLIOTECAS</h1>
                        </Row>
                    ...
                    <div className='generic-container generic-container-variant-1'>
                        ...
                        <div className='dependencia-responsabilidad-container'>
                            <p>Las bibliotecas municipales son las responsables de proporcionar acceso gratuito a una amplia gama
de recursos informativos, incluyendo libros, revistas y recursos en línea. Esto ayudando a fomentar la
educación, la investigación y el aprendizaje continuo en la comunidad.</p>
                        </div>
                    </div>
                </Col>
            </Row>
